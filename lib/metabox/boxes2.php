...
if(empty($main_options['paypal_email'])){
...
Scroll up to add a price to this item.</div>';
	...
	$meta_boxes[] = array(
		...
		'fields'     => array(
			...
			$main_options['use_paypal'] == 'on' || $main_options['use_kickstart'] == 'on' ?						
			array(
				'name' => 'Book Price',
